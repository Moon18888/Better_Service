...
(5, '2025-01-05', 23593, 'IP conflict', 'Two devices have the same IP address', 2, 2, 2, 5, 6, 1, 23623),
(6, '2025-01-06', 23594, 'DNS issue', 'User cannot resolve domain names', 3, 3, 3, 6, 10, 1, 23620),
(7, '2025-01-07', 23595, 'Peripheral issue', 'Printer is not working', 1, 1, 1, 7, 8, 2, 23621),
(8, '2025-01-08', 23596, 'Bitlocker problem', 'User cannot unlock Bitlocker drive', 2, 2, 2, 8, 8, 2, 23622),
(9, '2025-01-09', 23597, 'SAP error', 'SAP transaction fails', 3, 3, 3, 9, 10, 3, 23623),
(10, '2025-01-10', 23598, 'M365 issue', 'User cannot access M365 services', 1, 1, 1, 10, 10, 3, 23619),
(11, '2025-01-11', 23599, 'Malware detected', 'Antivirus detected malware', 2, 2, 2, 11, 12, 4, 23620),
(12, '2025-01-12', 23600, 'Phishing attempt', 'User received a phishing email', 3, 3, 3, 12, 12, 4, 23621),
...
(17, '2025-01-17', 23605, 'IP conflict', 'Two devices have the same IP address', 2, 2, 2, 5, 6, 1, 23621),
(18, '2025-01-18', 23606, 'DNS issue', 'User cannot resolve domain names', 3, 3, 3, 6, 10, 1, 23622),
(19, '2025-01-19', 23607, 'Peripheral issue', 'Printer is not working', 1, 1, 1, 7, 8, 2, 23623),
(20, '2025-01-20', 23608, 'Bitlocker problem', 'User cannot unlock Bitlocker drive', 2, 2, 2, 8, 8, 2, 23619),
(21, '2025-01-21', 23609, 'SAP error', 'SAP transaction fails', 3, 3, 3, 9, 10, 3, 23620),
(22, '2025-01-22', 23610, 'M365 issue', 'User cannot access M365 services', 1, 1, 1, 10, 10, 3, 23621),
(23, '2025-01-23', 23611, 'Malware detected', 'Antivirus detected malware', 2, 2, 2, 11, 12, 4, 23622),
(24, '2025-01-24', 23612, 'Phishing attempt', 'User received a phishing email', 3, 3, 3, 12, 12, 4, 23623),
...
(29, '2025-01-29', 23617, 'IP conflict', 'Two devices have the same IP address', 2, 2, 2, 5, 6, 1, 23623),
(30, '2025-01-30', 23618, 'DNS issue', 'User cannot resolve domain names', 3, 3, 3, 6, 10, 1, 23619),
(31, '2025-01-31', 23619, 'Peripheral issue', 'Printer is not working', 1, 1, 1, 7, 8, 2, 23620),
(32, '2025-02-01', 23620, 'Bitlocker problem', 'User cannot unlock Bitlocker drive', 2, 2, 2, 8, 8, 2, 23621),
(33, '2025-02-02', 23621, 'SAP error', 'SAP transaction fails', 3, 3, 3, 9, 10, 3, 23622),
(34, '2025-02-03', 23622, 'M365 issue', 'User cannot access M365 services', 1, 1, 1, 10, 10, 3, 23623),
(35, '2025-02-04', 23623, 'Malware detected', 'Antivirus detected malware', 2, 2, 2, 11, 12, 4, 23619),
(36, '2025-02-05', 23589, 'Phishing attempt', 'User received a phishing email', 3, 3, 3, 12, 12, 4, 23620),
...
(41, '2025-02-10', 23594, 'IP conflict', 'Two devices have the same IP address', 2, 2, 2, 5, 6, 1, 23620),
(42, '2025-02-11', 23595, 'DNS issue', 'User cannot resolve domain names', 3, 3, 3, 6, 10, 1, 23621),
(43, '2025-02-12', 23596, 'Peripheral issue', 'Printer is not working', 1, 1, 1, 7, 8, 2, 23622),
(44, '2025-02-13', 23597, 'Bitlocker problem', 'User cannot unlock Bitlocker drive', 2, 2, 2, 8, 8, 2, 23623),
(45, '2025-02-14', 23598, 'SAP error', 'SAP transaction fails', 3, 3, 3, 9, 10, 3, 23619),
(46, '2025-02-15', 23599, 'M365 issue', 'User cannot access M365 services', 1, 1, 1, 10, 10, 3, 23620),
(47, '2025-02-16', 23600, 'Malware detected', 'Antivirus detected malware', 2, 2, 2, 11, 12, 4, 23621),
(48, '2025-02-17', 23601, 'Phishing attempt', 'User received a phishing email', 3, 3, 3, 12, 12, 4, 23622),
...
(53, '2025-02-22', 23606, 'IP conflict', 'Two devices have the same IP address', 2, 2, 2, 5, 6, 1, 23622),
(54, '2025-02-23', 23607, 'DNS issue', 'User cannot resolve domain names', 3, 3, 3, 6, 10, 1, 23623),
(55, '2025-02-24', 23608, 'Peripheral issue', 'Printer is not working', 1, 1, 1, 7, 8, 2, 23619),
(56, '2025-02-25', 23609, 'Bitlocker problem', 'User cannot unlock Bitlocker drive', 2, 2, 2, 8, 8, 2, 23620),
(57, '2025-02-26', 23610, 'SAP error', 'SAP transaction fails', 3, 3, 3, 9, 10, 3, 23621),
(58, '2025-02-27', 23611, 'M365 issue', 'User cannot access M365 services', 1, 1, 1, 10, 10, 3, 23622),
(59, '2025-02-28', 23612, 'Malware detected', 'Antivirus detected malware', 2, 2, 2, 11, 12, 4, 23623),
(60, '2025-03-01', 23613, 'Phishing attempt', 'User received a phishing email', 3, 3, 3, 12, 12, 4, 23619),
...
(65, '2025-03-06', 23618, 'IP conflict', 'Two devices have the same IP address', 2, 2, 2, 5, 6, 1, 23619),
(66, '2025-03-07', 23619, 'DNS issue', 'User cannot resolve domain names', 3, 3, 3, 6, 10, 1, 23620),
(67, '2025-03-08', 23620, 'Peripheral issue', 'Printer is not working', 1, 1, 1, 7, 8, 2, 23621),
(68, '2025-03-09', 23621, 'Bitlocker problem', 'User cannot unlock Bitlocker drive', 2, 2, 2, 8, 8, 2, 23622),
(69, '2025-03-10', 23622, 'SAP error', 'SAP transaction fails', 3, 3, 3, 9, 10, 3, 23623),
(70, '2025-03-11', 23623, 'M365 issue', 'User cannot access M365 services', 1, 1, 1, 10, 10, 3, 23619),
(71, '2025-03-12', 23589, 'Malware detected', 'Antivirus detected malware', 2, 2, 2, 11, 12, 4, 23620),
(72, '2025-03-13', 23590, 'Phishing attempt', 'User received a phishing email', 3, 3, 3, 12, 12, 4, 23621),
...
(77, '2025-03-18', 23595, 'IP conflict', 'Two devices have the same IP address', 2, 2, 2, 5, 6, 1, 23621),
(78, '2025-03-19', 23596, 'DNS issue', 'User cannot resolve domain names', 3, 3, 3, 6, 10, 1, 23622),
(79, '2025-03-20', 23597, 'Peripheral issue', 'Printer is not working', 1, 1, 1, 7, 8, 2, 23623),
(80, '2025-03-21', 23598, 'Bitlocker problem', 'User cannot unlock Bitlocker drive', 2, 2, 2, 8, 8, 2, 23619),
(81, '2025-03-22', 23599, 'SAP error', 'SAP transaction fails', 3, 3, 3, 9, 10, 3, 23620),
(82, '2025-03-23', 23600, 'M365 issue', 'User cannot access M365 services', 1, 1, 1, 10, 10, 3, 23621);
